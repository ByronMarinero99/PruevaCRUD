...
namespace CRUD.LogicaDeNegocio
{
    public class UsuarioBL
    {
        ...
        public async Task<List<Usuario>> buscarincluirproductoasync(Usuario pUsuario)
        {
            return await UsuarioDAL.BuscarIncluirProductoAsync(pUsuario);
        }
    }
}
